ig.module( 'game.entities.e_orange' )
...
EntityE_orange = ig.Entity.extend({
	...
	init: function ( x,y, settings){
		...
		this.addAnim( 'crawl', 0.1, [3] );
		this.addAnim( 'ghost', 1, [4] ); 

		ig.game.e_orange = this;
...
//*/
	...
	// this is to see the path / remove when nolonger needed
	draw: function() {
		if(!ig.global.wm) {
			// Draw the path ...
			this.drawPath(255, 143, 255, 0.5);
		}
